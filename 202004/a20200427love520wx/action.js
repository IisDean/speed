...
milo.ready(function () {
    need("biz.login", function (LoginManager) {
        LoginManager.checkLogin(function(userInfo){
            ...
            // alert('wx已登录');
            if (LoginManager.isQQApp()) {
                // alert("qq->wx");
                //如果在QQapp中打开微信页面，则跳到转微信页面
            ...
            if (milo.cookie.get("acctype") == "wx"){
                LoginManager.getUserInfoByWxOpenId({
                    ...
                    // alert('登录成功');
                    // alert(decodeURIComponent(WxUserInfo.nickname));
                    $("#userinfo").html(decodeURIComponent(WxUserInfo.nickname));
                },function(err){
                    // alert('获取用户信息失败');
            ...
            if (LoginManager.isQQApp()) {
                //如果在QQ app中打开微信页面，则跳到转微信页面
                window.location.href = "https://game.weixin.qq.com/cgi-bin/comm/openlink?noticeid=90243170&appid=wxca6215f6c23c2e90&url=https%3A%2F%2Flove.qq.com%2Fcp%2Fa20200427love520wx%2Findex.html"; //这里放openlink
            } else if (LoginManager.isWxApp()) {
                ...
                //跳转到微信页面
                // window.location.href = 'https://game.weixin.qq.com/cgi-bin/comm/openlink?noticeid=90243170&appid=wxca6215f6c23c2e90&url=https%3A%2F%2Flove.qq.com%2Fcp%2Fa20200427love520wx%2Findex.html';
                ...
                //         }
                //     },
                //     fBeforeQQLogin: function () {
                //         if (!LoginManager.isQQApp() && !LoginManager.isWxApp()) {
