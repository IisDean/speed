...
window.iGameType =2;
window.iQualType =2;
window.qZigeFlow =655095;
window.qJfFlow =655096;
window.qDsFlow =0;
window.iSighQueryFlow=0;
window.iMyAddressId=655086;
window.iDecryptFlow=0;
window.iInviteFlow=0;
window.needAddress=0;
window.iActivityId=296559;
window.iBindAreaId = 655081;
window.iInitAreaId = iBindAreaId + 1;
window.iLotteryId = 340398;
window.iMyListId = 655083;
window.iGiftArea = 1;
window.sService = 'cfm';
window.gLubanId = 1846;
window.iMrmsBind = 1;
