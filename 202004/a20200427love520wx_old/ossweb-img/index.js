    ...
    var msgTextList = [//文案列表
        '提到套路，通常你都是被套路的那个。陌生人面前比较高冷的你，反倒会引起很多人的关注，但是大多数情况，都是别人追你逃的状态，想要追到你可不是件容易的事。所以，奉劝那些想要追你的人多点耐心，才有机会看到你真正可爱的一面，而你也要记得多给别人一些机会噢~',
        '外在条件很不错的你，在爱情的道路上却总是受伤~你在恋爱中温柔、好相处的性格，很容易变成被欺负的一方，想抱抱一直付出的你。有时候，爱情也需要一些技巧，让人知道你的边界。但是在爱情中跌倒又站起来，获得了成长的人，往往才是最后真正幸福的。',
        '我想说，遇见你真是爱情中的小确幸呢。你有种独特的初恋气息，周围的人都会被你的单纯所感染，想在夏日午后的课间，在你桌上放一瓶冰冰的波子汽水。年少时的恋爱，干净的没有一丝杂质，你就是有这种魔力，让恋爱回到最初的模样。',
        '偶尔在网上看到的新鲜小套路，你也会想要在恋爱中进行实践，只可惜你玩起套路来又单纯又可爱，说点套路的话，恐怕自己都要脸红尴尬，对方都不忍心拆穿你~也许在恋爱中，没有套路就是最深的套路吧。',
        '这里想为你澄清一下，你并不是故意套路，但有时候乱拳打死老师傅说的就是你。古灵精怪、脑回路清奇的你，时常能让别人掉进你的陷阱，因此你常常能在感情中占据上风，让人又爱又恨。但是被聪明鬼马、懂得分寸的你牵着鼻子走，也未尝不是一种乐趣~',
        '套路是你恋爱中的调味品。和你恋爱的过程充满了小甜蜜、小惊喜，是一定不会无聊的~你骨子里是一个浪漫主义的人，营造氛围的高手，愿意为另一半制造生活中的小情调，烛光晚餐、旅游出行、节日惊喜都是你的拿手好戏。经历过你的小套路，可能很难再爱上别人了~',
        '恋爱小天才说的就是你吧！心思细腻，聪明敏锐的你，从对方的一个动作、一个眼神就能看出他的心思，让人觉得找到了灵魂伴侣。所以即使分开了，你也是一个让前任想起来就辗转难眠的存在。作为感情中天赋异禀的高端玩家，就看你想不想入局开一把游戏了。',
        '大师！快写一本《恋爱千层套路》拯救一下在爱情中迷路的众生吧！在恋爱中如鱼得水的你，不仅对自己的感情经营有道，周围人也时常向你请教感情相关的问题。只是，游刃有余的你，是否也会对过于擅长的领域感到厌倦，反而想要单纯的恋爱呢？',
        ],
        labelList = [//资质
            ['恋爱小白', '拒绝套路'],
            ['恋爱小迷糊', '温柔可爱'],
    ...
    var $nameWrap = $('.J-name-text'),
        ...
        $labelList = $(".J-label-list .label-item"),
    ...
    function createResult(){
        ...
        $labelList.eq(0).find('span').text(labelList[resultList[grade].label][0]);
        $labelList.eq(1).find('span').text(labelList[resultList[grade].label][1]);
        // $msgWrap.text(msgTextList[resultList[grade].msgText]);
        $msgWrap.text(msgTextList[0]);
