...
$(".select-ok-btn").on("click", function(){
    ...
    // $(".part-3").show();
    nextPageRead(3);
    $(".answer-hz-icon").css('background-image', 'url(//game.gtimg.cn/images/lv/cp/a20200427love520huawei/badge_'+hzIdx+'.png)');
...
function createResult(){
    var pIdx = getRandom(1, 4),//随机人物状态 可为1~4状态，对应当前人物的不同状态
        wordSrc = '//game.gtimg.cn/images/lv/cp/a20200427love520huawei/h_'+ hzIdx,//话语
        badgeSrc = '//game.gtimg.cn/images/lv/cp/a20200427love520huawei/badge_result_'+ hzIdx +'.png';//徽章
    grade >= 20 ? wordSrc=wordSrc+'_up.png' : wordSrc=wordSrc+'_down.png';
    $perImg.attr("src", '//game.gtimg.cn/images/lv/cp/a20200427love520huawei/person_'+hzIdx+'_'+pIdx+'.png');//更新封面
    ...
    $(".code-icon").css("background-image", "url('//game.gtimg.cn/images/lv/cp/a20200427love520huawei/code_icon"+hzIdx+".png')");
    // $(".part-4").show();
