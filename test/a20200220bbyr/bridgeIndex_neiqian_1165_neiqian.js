...
amsCfg_644612 = {
    ...
    'onGetGiftFailureEvent' : function(callbackObj){// 抽奖失败事件
        ...
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('failed', 644612 , callbackObj);
        }
    ...
    'onGetGiftSuccessEvent' : function(callbackObj){// 抽奖成功事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('success', 644612 , callbackObj);
        }
...
amsCfg_644615 = {
    ...
    'onGetGiftFailureEvent' : function(callbackObj){// 抽奖失败事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('failed', 644615 , callbackObj);
        }
        alert(callbackObj.sMsg);
    },
    'onGetGiftSuccessEvent' : function(callbackObj){// 抽奖成功事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('success', 644615 , callbackObj);
        }
        var packageLen = callbackObj.iPackageId ? callbackObj.iPackageId.split(',') : '';
        if(false && typeof window.iSighQueryFlow != "undefined" && window.iSighQueryFlow != 0 ){
            amsInit(iActivityId, iSighQueryFlow);
...
amsCfg_644616 = {
    ...
    'onGetGiftFailureEvent' : function(callbackObj){// 抽奖失败事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('failed', 644616 , callbackObj);
        }
        alert(callbackObj.sMsg);
    },
    'onGetGiftSuccessEvent' : function(callbackObj){// 抽奖成功事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('success', 644616 , callbackObj);
        }
        var packageLen = callbackObj.iPackageId ? callbackObj.iPackageId.split(',') : '';
        if(false && typeof window.iSighQueryFlow != "undefined" && window.iSighQueryFlow != 0 ){
            amsInit(iActivityId, iSighQueryFlow);
...
amsCfg_644617 = {
    ...
    'onGetGiftFailureEvent' : function(callbackObj){// 抽奖失败事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('failed', 644617 , callbackObj);
        }
        alert(callbackObj.sMsg);
    },
    'onGetGiftSuccessEvent' : function(callbackObj){// 抽奖成功事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('success', 644617 , callbackObj);
        }
        var packageLen = callbackObj.iPackageId ? callbackObj.iPackageId.split(',') : '';
        if(false && typeof window.iSighQueryFlow != "undefined" && window.iSighQueryFlow != 0 ){
            amsInit(iActivityId, iSighQueryFlow);
...
amsCfg_644618 = {
    ...
    'onGetGiftFailureEvent' : function(callbackObj){// 抽奖失败事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('failed', 644618 , callbackObj);
        }
        alert(callbackObj.sMsg);
    },
    'onGetGiftSuccessEvent' : function(callbackObj){// 抽奖成功事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('success', 644618 , callbackObj);
        }
        var packageLen = callbackObj.iPackageId ? callbackObj.iPackageId.split(',') : '';
        if(false && typeof window.iSighQueryFlow != "undefined" && window.iSighQueryFlow != 0 ){
            amsInit(iActivityId, iSighQueryFlow);
...
var jfIdMap = {"1055":"795"};
var flowIdMap = {"8648":"644612","8649":"644615","8650":"644616","8651":"644617","8652":"644618","8678":"644619","8679":"644620"};
var flowIdValid = ["644612","644615","644616","644617","644618"];
// 查询资格流程
	amsCfg_644619 = {
    ...
    "sNeedSubmitPopDiv":  false , // 是否开启loading层
		"fFlowSubmitEnd": function(res){
			// 自定义回调
            if (typeof lbCallBackOfAmsSubmit == 'function') {
                lbCallBackOfAmsSubmit('success', 644619 , res);
            }	
		...
		"fFlowSubmitFailed":function(res){
			// 自定义回调
            if (typeof lbCallBackOfAmsSubmit == 'function') {
                lbCallBackOfAmsSubmit('failed', 644619 , res);
            }	
			//失败会走到这个函数
...
// 查询积分流程
    ...
    "sNeedSubmitPopDiv":  false , // 是否开启loading层
		"fFlowSubmitEnd": function(res){
            // 自定义回调
            if (typeof lbCallBackOfAmsSubmit == 'function') {
                lbCallBackOfAmsSubmit('success', 644620 , res);
            }			
			//console.log(res);
			var sOutValue1 = res.sOutValue1;
			...
			process_deli($('#Jf_795_2').html())
			return;
		},
		"fFlowSubmitFailed":function(res){
            // 自定义回调
            if (typeof lbCallBackOfAmsSubmit == 'function') {
                lbCallBackOfAmsSubmit('failed', 644620 , res);
            }			
			//失败会走到这个函数
			//条件不满足，ame返回大于0是后走到这里
			alert(res.sMsg);
...
var WxQqShareInfo = {"iType":1,"sShareTitle":"\u4e1b\u6797\u7248\u672c\u76f4\u901a\u8f66-\u7a7f\u8d8a\u706b\u7ebf\u624b\u6e38\u5b98\u65b9\u7f51\u7ad9-\u817e\u8baf\u6e38\u620f","sShareDesc":"\u300a\u7a7f\u8d8a\u706b\u7ebf\u624b\u6e38\u300b\u4e1b\u6797\u7248\u672c\u76f4\u901a\u8f66\uff0c\u6d77\u91cf\u5927\u793c\u7b49\u4f60\u6765\u9886\uff01","sShareImgUrl":"https:\/\/game.gtimg.cn\/images\/codo\/act\/lb_atemple\/img\/share\/gameIcon.jpg","sShareLink":"https:\/\/cfm.qq.com\/lbact\/a20200220bbyr\/h5.html"};
...
if(!isMSDK()){
	window.location.href="//cfm.qq.com/lbact/a20200220bbyr/h5.html";
}
var cfmUserInfo = {
	nickName: "",
	isLogin: false
    ...
    $(function(){
        need("biz.login",function(LoginManager){
			...
			LoginManager.checkLogin(function(user){
				...
				delete amsCfg_644612.sData.appid;delete amsCfg_644612.sData.ams_appname;delete amsCfg_644612.sData.ams_targetappid; amsCfg_644612.sData.sArea = myarea; amsCfg_644612.sData.sPlatId = myplatid; delete amsCfg_644615.sData.appid;delete amsCfg_644615.sData.ams_appname;delete amsCfg_644615.sData.ams_targetappid; amsCfg_644615.sData.sArea = myarea; amsCfg_644615.sData.sPlatId = myplatid; delete amsCfg_644616.sData.appid;delete amsCfg_644616.sData.ams_appname;delete amsCfg_644616.sData.ams_targetappid; amsCfg_644616.sData.sArea = myarea; amsCfg_644616.sData.sPlatId = myplatid; delete amsCfg_644617.sData.appid;delete amsCfg_644617.sData.ams_appname;delete amsCfg_644617.sData.ams_targetappid; amsCfg_644617.sData.sArea = myarea; amsCfg_644617.sData.sPlatId = myplatid; delete amsCfg_644618.sData.appid;delete amsCfg_644618.sData.ams_appname;delete amsCfg_644618.sData.ams_targetappid; amsCfg_644618.sData.sArea = myarea; amsCfg_644618.sData.sPlatId = myplatid; delete amsCfg_644619.sData.appid;delete amsCfg_644619.sData.ams_appname;delete amsCfg_644619.sData.ams_targetappid; amsCfg_644619.sData.sArea = myarea; amsCfg_644619.sData.sPlatId = myplatid; delete amsCfg_644620.sData.appid;delete amsCfg_644620.sData.ams_appname;delete amsCfg_644620.sData.ams_targetappid; amsCfg_644620.sData.sArea = myarea; amsCfg_644620.sData.sPlatId = myplatid; 
delete amsCfg_644610.sData.appid;delete amsCfg_644610.sData.ams_appname;delete amsCfg_644610.sData.ams_targetappid; amsCfg_644610.sData.sArea = myarea; amsCfg_644610.sData.sPlatId = myplatid; 
delete amsCfg_644613.sData.appid;delete amsCfg_644613.sData.ams_appname;delete amsCfg_644613.sData.ams_targetappid; amsCfg_644613.sData.sArea = myarea; amsCfg_644613.sData.sPlatId = myplatid; 
