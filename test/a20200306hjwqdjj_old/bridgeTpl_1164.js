...
window.iGameType =1;
window.iQualType =1;
window.qZigeFlow =644062;
window.qJfFlow =644063;
window.qDsFlow =644064;
window.iSighQueryFlow=0;
window.iMyAddressId=644040;
window.iDecryptFlow=0;
window.iInviteFlow=0;
window.needAddress=0;
window.iActivityId=287607;
window.iBindAreaId = 644035;
window.iInitAreaId = iBindAreaId + 1;
window.iLotteryId = 333084;
window.iMyListId = 644037;
window.iGiftArea = 1;
window.sService = 'codo';
window.gLubanId = 1630;
window.iMrmsBind = 1;
