    ...
    $(".select-ok-btn").on("click", function(){
        ...
        // $(".part-3").show();
        nextPageRead(3);
        $(".answer-hz-icon").css('background-image', 'url(//game.gtimg.cn/images/lv/cp/a20200427love520qq/badge_'+hzIdx+'.png)');
    ...
    function createResult(){
        var pIdx = getRandom(1, 4),//随机人物状态 可为1~4状态，对应当前人物的不同状态
            wordSrc = '//game.gtimg.cn/images/lv/cp/a20200427love520qq/h_'+ hzIdx,//话语
            badgeSrc = '//game.gtimg.cn/images/lv/cp/a20200427love520qq/badge_result_'+ hzIdx +'.png';//徽章
        grade >= 20 ? wordSrc = wordSrc+'_up.png' : wordSrc = wordSrc+'_down.png';
        $perImg.attr("src", '//game.gtimg.cn/images/lv/cp/a20200427love520qq/person_'+hzIdx+'_'+pIdx+'.png');//更新封面
        ...
        $(".code-icon").css("background-image", "url('//game.gtimg.cn/images/lv/cp/a20200427love520qq/code_icon"+hzIdx+".png')");
        ...
        //缓存至本地，抽奖页面读取
        var posterData = {
            userName: $(".J-name-text").text(),
            hzIdx: hzIdx,
            perImg: '//game.gtimg.cn/images/lv/cp/a20200427love520qq/person_'+hzIdx+'_'+pIdx+'.png',//封面
            wordSrc: '//game.gtimg.cn/images/lv/cp/a20200427love520qq/h_'+ hzIdx,//话语
            badgeSrc: '//game.gtimg.cn/images/lv/cp/a20200427love520qq/badge_result_'+ hzIdx +'.png',//徽章
            pilesNum: resultList[grade].plies,//更新层数
            labelList: [
                labelList[resultList[grade].label][0],
                labelList[resultList[grade].label][1]
            ],
            codeSrc: $("#qrcode img").attr("src"),
            codeIcon: '//game.gtimg.cn/images/lv/cp/a20200427love520qq/code_icon'+hzIdx+'.png',//二维码图标
            msgText: msgTextList[resultList[grade].msgText],//描述
        };
        posterData = JSON.stringify(posterData);
        sessionStorage.setItem('posterData', posterData);
    }
