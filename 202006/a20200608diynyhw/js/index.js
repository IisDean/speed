var ctrlJs = {
    ...
    methods: {
        ...
        createResult: function(){
            ...
            var resultSrc = 'img/result_'+ resultData.jd +'_'+ resultData.gz +'.jpg';
            ctrlJs.data.yySrc = 'audio/yy_'+ resultData.jd +'.mp3';
    ...
    init: function(){
        ...
        $(".btn-cycj1").on("click", function(){
            ...
            if( !that.data.isJsYy ){ 
                ...
                $(".play-yy-btn").removeClass("filter");
            }else {
                $(".play-yy-btn").click();
            }
        });
