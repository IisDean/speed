...
window.iGameType =2;
window.iQualType =2;
window.qZigeFlow =647146;
window.qJfFlow =647147;
window.qDsFlow =0;
window.iSighQueryFlow=0;
window.iMyAddressId=647092;
window.iDecryptFlow=0;
window.iInviteFlow=0;
window.needAddress=0;
window.iActivityId=290019;
window.iBindAreaId = 647087;
window.iInitAreaId = iBindAreaId + 1;
window.iLotteryId = 335033;
window.iMyListId = 647089;
window.iGiftArea = 1;
window.sService = 'cfm';
window.gLubanId = 1640;
window.iMrmsBind = 1;
