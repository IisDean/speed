...
window.iGameType =2;
window.iQualType =2;
window.qZigeFlow =687498;
window.qJfFlow =0;
window.qDsFlow =0;
window.iSighQueryFlow=0;
window.iMyAddressId=687492;
window.iDecryptFlow=0;
window.iInviteFlow=0;
window.needAddress=0;
window.iActivityId=320708;
window.iBindAreaId = 687487;
window.iInitAreaId = iBindAreaId + 1;
window.iLotteryId = 359387;
window.iMyListId = 687489;
window.iGiftArea = 1;
window.sService = 'cfm';
window.gLubanId = 2241;
window.iMrmsBind = 1;
