var ctrlJs = {
    data: {
        ...
        mpList: {
            mp_sd: {
                name: '神刀',
                posterSrc: '//game.gtimg.cn/images/wuxia/act/a20200702zztest/ossweb-img/result_shendao.png'
            },
            mp_sl: {
                name: '少林',
                posterSrc: '//game.gtimg.cn/images/wuxia/act/a20200702zztest/ossweb-img/result_shaolin.png'
            },
            mp_tb: {
                name: '太白',
                posterSrc: '//game.gtimg.cn/images/wuxia/act/a20200702zztest/ossweb-img/result_taibai.png'
            },
            mp_sw: {
                name: '神威',
                posterSrc: '//game.gtimg.cn/images/wuxia/act/a20200702zztest/ossweb-img/result_shenwei.png'
            },
            mp_tm: {
                name: '唐门',
                posterSrc: '//game.gtimg.cn/images/wuxia/act/a20200702zztest/ossweb-img/result_tangmen.png'
            },
            mp_tx: {
                name: '天香',
                posterSrc: '//game.gtimg.cn/images/wuxia/act/a20200702zztest/ossweb-img/result_tianxiang.png'
            },
            mp_wd: {
                name: '五毒',
                posterSrc: '//game.gtimg.cn/images/wuxia/act/a20200702zztest/ossweb-img/result_wudu.png'
            },
            mp_yh: {
                name: '移花',
                posterSrc: '//game.gtimg.cn/images/wuxia/act/a20200702zztest/ossweb-img/result_yihua.png'
            },
            mp_gb: {
                name: '丐帮',
                posterSrc: '//game.gtimg.cn/images/wuxia/act/a20200702zztest/ossweb-img/result_gaibang.png'
            },
            mp_zw: {
                name: '真武',
                posterSrc: '//game.gtimg.cn/images/wuxia/act/a20200702zztest/ossweb-img/result_zhenwu.png'
            }
        },
        //问题列表
        questionList: {
        ...
        loadImgList: [
            '//game.gtimg.cn/images/wuxia/act/a20200702zztest/ossweb-img/p2_options_active.png',
        ],//图片预加载列表
...
$(function () {
    ...
    //首页过场动画
    var src='//game.gtimg.cn/images/wuxia/act/a20200702zztest/ossweb-img/interlude.mp4';    
    ...
    $(".question-list").on("click", "a", function(){
        ...
        setTimeout(function(){
            if(obj.options[idx].result){
                ...
                //进入下一题
                var next = obj.options[idx].next;
                if(typeof next === 'object'){
                    next = next[ctrlJs.methods.getRandom(0, next.length)];
                }
                ctrlJs.data.activeKey = next;
