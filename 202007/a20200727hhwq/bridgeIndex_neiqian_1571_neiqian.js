...
amsCfg_687491 = {
    ...
    'onGetGiftFailureEvent' : function(callbackObj){// 抽奖失败事件
        ...
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('failed', 687491 , callbackObj);
        }
		
		window.location.href="//cfm.qq.com/ingame/web201809/detail.shtml?nid=11761624" 
        		if(callbackObj.sMsg=='111'){
			return;
		}else{
    ...
    'onGetGiftSuccessEvent' : function(callbackObj){// 抽奖成功事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('success', 687491 , callbackObj);
        }
...
amsCfg_689142 = {
    ...
    'onGetGiftFailureEvent' : function(callbackObj){// 抽奖失败事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('failed', 689142 , callbackObj);
        }
        		if(callbackObj.sMsg=='111'){
			return;
		}else{
    ...
    'onGetGiftSuccessEvent' : function(callbackObj){// 抽奖成功事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('success', 689142 , callbackObj);
        }
        var packageLen = callbackObj.iPackageId ? callbackObj.iPackageId.split(',') : '';
        if(false && typeof window.iSighQueryFlow != "undefined" && window.iSighQueryFlow != 0 ){
            amsInit(iActivityId, iSighQueryFlow);
...
amsCfg_689143 = {
    ...
    'onGetGiftFailureEvent' : function(callbackObj){// 抽奖失败事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('failed', 689143 , callbackObj);
        }
        		if(callbackObj.sMsg=='111'){
			return;
		}else{
    ...
    'onGetGiftSuccessEvent' : function(callbackObj){// 抽奖成功事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('success', 689143 , callbackObj);
        }
        var packageLen = callbackObj.iPackageId ? callbackObj.iPackageId.split(',') : '';
        if(false && typeof window.iSighQueryFlow != "undefined" && window.iSighQueryFlow != 0 ){
            amsInit(iActivityId, iSighQueryFlow);
...
amsCfg_687604 = {
    ...
    'onGetGiftFailureEvent' : function(callbackObj){// 抽奖失败事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('failed', 687604 , callbackObj);
        }
    ...
    'onGetGiftSuccessEvent' : function(callbackObj){// 抽奖成功事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('success', 687604 , callbackObj);
        }
        var packageLen = callbackObj.iPackageId ? callbackObj.iPackageId.split(',') : '';
        if(false && typeof window.iSighQueryFlow != "undefined" && window.iSighQueryFlow != 0 ){
            amsInit(iActivityId, iSighQueryFlow);
...
amsCfg_687605 = {
    ...
    'onGetGiftFailureEvent' : function(callbackObj){// 抽奖失败事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('failed', 687605 , callbackObj);
        }
    ...
    'onGetGiftSuccessEvent' : function(callbackObj){// 抽奖成功事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('success', 687605 , callbackObj);
        }
        var packageLen = callbackObj.iPackageId ? callbackObj.iPackageId.split(',') : '';
        if(false && typeof window.iSighQueryFlow != "undefined" && window.iSighQueryFlow != 0 ){
            amsInit(iActivityId, iSighQueryFlow);
...
amsCfg_687496 = {
    ...
    'onGetGiftFailureEvent' : function(callbackObj){// 抽奖失败事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('failed', 687496 , callbackObj);
        }
        alert(callbackObj.sMsg);
    },
    'onGetGiftSuccessEvent' : function(callbackObj){// 抽奖成功事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('success', 687496 , callbackObj);
        }
        var packageLen = callbackObj.iPackageId ? callbackObj.iPackageId.split(',') : '';
        if(false && typeof window.iSighQueryFlow != "undefined" && window.iSighQueryFlow != 0 ){
            amsInit(iActivityId, iSighQueryFlow);
...
amsCfg_687497 = {
    ...
    'onGetGiftFailureEvent' : function(callbackObj){// 抽奖失败事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('failed', 687497 , callbackObj);
        }
        alert(callbackObj.sMsg);
    },
    'onGetGiftSuccessEvent' : function(callbackObj){// 抽奖成功事件
        // 自定义回调
        if (typeof lbCallBackOfAmsSubmit == 'function') {
            lbCallBackOfAmsSubmit('success', 687497 , callbackObj);
        }
        var packageLen = callbackObj.iPackageId ? callbackObj.iPackageId.split(',') : '';
        if(false && typeof window.iSighQueryFlow != "undefined" && window.iSighQueryFlow != 0 ){
            amsInit(iActivityId, iSighQueryFlow);
...
var flowIdMap = {"12255":"687491","12256":"687493","12259":"687494","12260":"687495","12261":"687496","12262":"687497","12263":"687498","12269":"687604","12270":"687605","12271":"687606","12373":"689142","12376":"689143"};
var flowIdValid = ["687491","687493","687494","687495","687496","687497","689142","689143"];
// 查询资格流程
	amsCfg_687498 = {
...
function showShareAndGet(iActivity,iFlow,func){
	if(!popup.isMobile()){
		...
		//$('#share_shadow').show();
		//$('.share-bg').show();
    	$('.btn-rule').css('z-index','9')
    	$('.share-guide-task p').html('请点击下方分享按钮分享出去哦~')
	
	    $('.share-guide-task').css('text-align','center').css('padding-top','25%').css('font-size','0.3rem').css('display','block').css('color','white').attr('onclick','deli_func()')
...
//下边处理微社区的活动跳转
var rqOpenid =  milo.request('openid') ;
if (myplatid == '' && myarea == '') {
	if (rqOpenid != '') { 
		var lenOfOpenid = rqOpenid.length;
		if (lenOfOpenid == 32) { //qq
			myarea = 2
		} else if (lenOfOpenid == 28) { //wx
			myarea = 1 
		}
		myplatid = isIOS() ? 0 : 1
	}
...
function doAmsAction(iAct,iFlow){
	...
	window["amsCfg_"+iFlow].sData.sDrUrl = window.location.search;
    window["amsCfg_"+iFlow].sData.sDrUA = navigator.userAgent;
    ...
    $(function(){
        need("biz.login",function(LoginManager){
			...
			LoginManager.checkLogin(function(user){
				...
				delete amsCfg_687491.sData.appid;delete amsCfg_687491.sData.ams_appname;delete amsCfg_687491.sData.ams_targetappid; amsCfg_687491.sData.sArea = myarea; amsCfg_687491.sData.sPlatId = myplatid; delete amsCfg_689142.sData.appid;delete amsCfg_689142.sData.ams_appname;delete amsCfg_689142.sData.ams_targetappid; amsCfg_689142.sData.sArea = myarea; amsCfg_689142.sData.sPlatId = myplatid; delete amsCfg_689143.sData.appid;delete amsCfg_689143.sData.ams_appname;delete amsCfg_689143.sData.ams_targetappid; amsCfg_689143.sData.sArea = myarea; amsCfg_689143.sData.sPlatId = myplatid; delete amsCfg_687604.sData.appid;delete amsCfg_687604.sData.ams_appname;delete amsCfg_687604.sData.ams_targetappid; amsCfg_687604.sData.sArea = myarea; amsCfg_687604.sData.sPlatId = myplatid; delete amsCfg_687605.sData.appid;delete amsCfg_687605.sData.ams_appname;delete amsCfg_687605.sData.ams_targetappid; amsCfg_687605.sData.sArea = myarea; amsCfg_687605.sData.sPlatId = myplatid; delete amsCfg_687496.sData.appid;delete amsCfg_687496.sData.ams_appname;delete amsCfg_687496.sData.ams_targetappid; amsCfg_687496.sData.sArea = myarea; amsCfg_687496.sData.sPlatId = myplatid; delete amsCfg_687497.sData.appid;delete amsCfg_687497.sData.ams_appname;delete amsCfg_687497.sData.ams_targetappid; amsCfg_687497.sData.sArea = myarea; amsCfg_687497.sData.sPlatId = myplatid; delete amsCfg_687498.sData.appid;delete amsCfg_687498.sData.ams_appname;delete amsCfg_687498.sData.ams_targetappid; amsCfg_687498.sData.sArea = myarea; amsCfg_687498.sData.sPlatId = myplatid; delete amsCfg_687606.sData.appid;delete amsCfg_687606.sData.ams_appname;delete amsCfg_687606.sData.ams_targetappid; amsCfg_687606.sData.sArea = myarea; amsCfg_687606.sData.sPlatId = myplatid; 
delete amsCfg_687489.sData.appid;delete amsCfg_687489.sData.ams_appname;delete amsCfg_687489.sData.ams_targetappid; amsCfg_687489.sData.sArea = myarea; amsCfg_687489.sData.sPlatId = myplatid; 
delete amsCfg_687492.sData.appid;delete amsCfg_687492.sData.ams_appname;delete amsCfg_687492.sData.ams_targetappid; amsCfg_687492.sData.sArea = myarea; amsCfg_687492.sData.sPlatId = myplatid; 
