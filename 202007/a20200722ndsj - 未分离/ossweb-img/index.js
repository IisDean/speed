var ctrlJs = {
    data: {
        ...
        //图片预加载列表
        loadImgList: [
            './ossweb-img/content_bg2.png',
            './ossweb-img/aload_icon.gif',
            './ossweb-img/badge_icon1.png',
            './ossweb-img/badge_icon2.png',
            './ossweb-img/bullet1.png',
            './ossweb-img/bullet2.png',
            './ossweb-img/data_border.png',
            './ossweb-img/default_avatar.jpg',
            './ossweb-img/icons.png',
            './ossweb-img/p1_inset.png',
            './ossweb-img/p2_inset1.png',
            './ossweb-img/p2_inset2.png',
            './ossweb-img/p2_inset3.png',
            './ossweb-img/p3_inset1.png',
            './ossweb-img/p3_inset2.png',
            './ossweb-img/p3_inset3.png',
            './ossweb-img/p4_inset1.png',
            './ossweb-img/p4_inset2.png',
            './ossweb-img/p4_inset3.png',
            './ossweb-img/p4_inset4.png',
            './ossweb-img/p5_inset1.png',
            './ossweb-img/p5_inset2.png',
            './ossweb-img/p5_inset3.png',
            './ossweb-img/prize_icon1.png',
        ],
